...
psp_models = {
    'resnet18': lambda: PSPNet(sizes=(1, 2, 3, 6), psp_size=512, deep_features_size=256, backend='resnet18', pretrained=False),
    'resnet34': lambda: PSPNet(sizes=(1, 2, 3, 6), psp_size=512, deep_features_size=256, backend='resnet34', pretrained=False),
    'resnet50': lambda: PSPNet(sizes=(1, 2, 3, 6), psp_size=2048, deep_features_size=1024, backend='resnet50', pretrained=False),
    'convnext_base':lambda: PSPNet(sizes=(1, 2, 3, 6), psp_size=512, deep_features_size=256, backend='convnext_base', pretrained=False),
    'convnext_large':lambda: PSPNet(sizes=(1, 2, 3, 6), psp_size=768, deep_features_size=384, backend='convnext_large', pretrained=False),
}
