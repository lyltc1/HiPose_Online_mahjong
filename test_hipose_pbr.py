...
def load_rgb_depth_path(rgb_folder, depth_folder):
    ...
    combined = list(zip(rgb_paths, depth_paths))
    random.shuffle(combined)
    rgb_paths, depth_paths = zip(*combined)
...
def prepare_input_dict(img_path, depth_path, Cam_K, detected_bbox):
    ...
    depth_image_mm = bop_dataset_single_obj_3d.read_depth(depth_path, 0.1)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--camera_path', default='/home/HiPose_Online_mahjong/output/dataset/camera_pbr.json')
    ...
    parser.add_argument('--rgb_path', default='/home/HiPose_Online_mahjong/output/dataset/test/rgb_pbr')
    parser.add_argument('--depth_path', default='/home/HiPose_Online_mahjong/output/dataset/test/depth_pbr')
    ...
    video_path = "/home/HiPose_Online_mahjong/output_video_pbr.avi"
    ...
    for rgb_path, depth_path in zip(rgb_paths, depth_paths):
        ...
        video_writer.write(resized_frame[:,:,::-1])
